...
def minDepth(root):
    if root is None:
        return 0
    if root.mLeftChild is None and root.mRightChild is None:
        return 1
    if root.mLeftChild is None:
        return minDepth(root.mRightChild) + 1
    if root.mRightChild is None:
        return minDepth(root.mLeftChild) + 1
    return min(minDepth(root.mLeftChild), minDepth(root.mRightChild))+1
