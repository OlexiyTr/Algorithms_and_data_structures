...
def __dfs_helper(graph, vertex):
    if vertex.color() == BLACK:
        return

    vertex.setColor(BLACK)
    for neighbour in graph[vertex].neighbors():
        __dfs_helper(graph, graph[neighbour])
...
print(findConnectedComponent(graph))
